...
const BusScheduleSchema = new Schema(
  {
    ...
    departure_time: {type: Number,default:null, required: true},
    arrival_time:{type: Number,default:null, required: true},
  ...
  transformData(rows) {
    ...
    rows.forEach((item) => {
      selectableItems.push({
        ...
        time: Utils.minTostr(item.departure_time || item.time),
