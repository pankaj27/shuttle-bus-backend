...
router
  ...
  .post(
    Validate(authValidation.sendPasswordReset),
...
router.route("/access").get(getAuth("master.admin"),controller.access);

router.route("/me").get(getAuth("master.admin"),controller.me);
...
router
   ...
   * * */
  .patch(
    getAuth("manage.admin.profile.update", "master.admin"),
    controller.status
  );
